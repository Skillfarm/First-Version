                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11" style="background-color: white;">
                            <div class="col-md-offset-3 col-md-7 col-xs-12" style="">
                                <div class="x_panel">
                                    <div class="x_title">

                                        <h2 class="navbar-right"> فرم ثبت کار <small></small></h2>
                                        <!--
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form class="form-horizontal form-label-left" action="Aworkadd" method="post" enctype="multipart/form-data">

                                            {{ csrf_field() }}
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <div class="form-group">
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input type="text" class="form-control" name="subject" style="direction:RTL;" placeholder="عنوان را وارد کنید...">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12"> زیرشاخه </label>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3 xdisplay_inputx has-feedback">
                                                    <input type="text" class="form-control has-feedback-left" id="single_cal2" name="deadtime" placeholder="Due Date" aria-describedby="inputSuccess2Status2">
                                                ...
                                                <div class="col-md-3 xdisplay_inputx has-feedback">
                                                    <input type="text" class="form-control has-feedback-left" id="single_cal2" name="wage" placeholder="wage" aria-describedby="inputSuccess2Status2">
                                                    <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"> </span>

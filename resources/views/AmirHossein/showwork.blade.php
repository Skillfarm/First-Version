                        ...
                        <div class="x_title">
                            ...
                            <div class="col-md-4">
                                <ul class="nav nav-pills" role="tablist">
                                    ...
                                    @if($workApplic == 'Y')
                                        <li role="presentation" class="dropdown">
                                        <form action="/Aapplicants" method="get" style="margin-top: 7px;">
                                            <button class="btn btn-info" id="drop4" href="#"  style="font-size: 15px;"  role="button" aria-expanded="false">
                                                درخواست دهندگان
                                            </button>
                                        </form>
                                    </li>
                            ...
                            <div class="row" style="direction: RTL;">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left" style="float: right">
                                        @if($workownerPB == 'Y')
                                            <div class="col-md-11 col-sm-4 col-xs-12 profile_details" style="float: right; padding: 0;">
...
کاردهنده
                                                    ...
                                                    <div class="right col-xs-4 text-center" style="float: right;">
                                                        <img src="{{url::to('/')}}/AmirHossein/Image/img.jpg" alt="" style="float: right; width: 80%; height: 80%;" class="img-circle">
                                                    </div>
                                                    <div class="left col-xs-8" dir="rtl">
                                                        <h2>{{$ownuser->name}}</h2>
                                                        <p>
                                                            <strong>
                                                            مهارت ها :
                                    ...
                                    <!-- About Work -->
                                    <div class="col-md-9 col-sm-3 col-xs-12 profile_left" style="float: right"  role="main">
                                        ...
                                        <div class="col-md-3" style="padding-left: 0%; align-items: stretch;">
                                            ...
                                            <div class="col-md-12" style="direction: RTL;">
                                                ...
                                                <div class="col-md-12 col-sm-3 col-xs-12">
                                                    <!-- About Work Panel -->
                                                    <section class="panel" style="border: 4px solid #E6E9ED; border-top: none;">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <!-- details -->
                                                            <p style="margin-left: 15px; margin-right: 15px;"> {{$workinf->details}} </p>
                                                            <!-- /details -->
                                                            ...
                                                            @foreach($ambigs as $app)
                                                                <li>
                                                                    ...
                                                                    @if($removeAmbig == 'Y')
                                                                        ...
                                                                        <form method="post" id="myform" action="/Aignoreambig/{{$app->id}}">
                                                                            {{ csrf_field() }}
                                                                            <a onclick="document.getElementById('myform').submit();" style="margin: 2px;">
                                                                                <span class="glyphicon glyphicon-ok" style="color: green; font-size: 20px" aria-hidden="true"></span>
                                                                            </a>
                                                                        </form>
                                                                        <form method="post" id="myform2" action="/Aremoveambig/{{$app->id}}">
                                                                            {{ csrf_field() }}
                                                                            <a onclick="document.getElementById('myform2').submit();"  style="margin: 2px;">

...
<head>
  ...
  <!-- Bootstrap -->
  <link href="{{{ asset('/Mohsen/Css/bootstrap.css') }}}" rel="stylesheet">
  <!-- Font Awesome -->
  <link href="{{{ asset('/Mohsen/font-awesome-4.6.3/Css/font-awesome.min.css') }}}" rel="stylesheet">
  <!-- NProgress -->
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-12 col-xs-12" style="float:right">
          <div class="x_panel" style="text-align: right;">
            <div class="x_title">
              <a class="title" href="/mbranchworks/{{$branch->id}}"> <h2 style="float: right;">{{ $branch->name}}</h2></a>
